export default function About() {
  return (
    <>
      ...
      <h2>What it does</h2>
      <p>Every answer is built deterministically: resolve the location, fetch weather, check stored warnings, grade forecast agreement from measured model disagreement, apply grounded rules where they exist — then phrase the result. The AI chooses words, never verdicts. Agreement grades are not probabilities.</p>
